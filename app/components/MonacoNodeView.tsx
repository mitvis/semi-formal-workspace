//github.com/TypeCellOS/TypeCell/blob/a9bd7956e69454f8bf28f3f47b2df9214b73e636/packages/frame/src/codeblocks/MonacoNodeView.tsx
...
const ComponentWithWrapper = (props: { htmlAttributes: any } & MonacoElementProps) => {
...
export function MonacoNodeView(inline: boolean) {
	const nodeView:
		...
		const BlockContent = (props: NodeViewProps & { selectionHack: any }) => {
			...
			const modelUri = uri.URI.parse(`file:///!${context.documentId}/${block.id}${suffix}.cell.tsx`)
