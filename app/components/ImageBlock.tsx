// https://github.com/TypeCellOS/BlockNote/blob/main/tests/src/utils/customblocks/Image.tsx
import { BlockNoteEditor, createBlockSpec, defaultProps } from '@blocknote/core'
